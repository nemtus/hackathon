...
import { PublicFinalJudge } from 'models/public/years/final-judges';

const PublicFinalJudgeForAwardCardWidgetComponent = (props: {
  submissionId: string;
  publicFinalJudge: PublicFinalJudge;
...
export default PublicFinalJudgeForAwardCardWidgetComponent;
