...
import PrivateUserYearJudgeCreateFormWidgetComponent from 'components/widgets/form/PrivateUserJudgeCreateForm';
import {
...
const JudgeCreatePageComponent = () => {
  ...
  return (
    <>
      ...
      configHackathonYearVote &&
      publicResults ? (
        <PrivateUserYearJudgeCreateFormWidgetComponent
          yearId={yearId}
          authUser={authUser}
...
export default JudgeCreatePageComponent;
